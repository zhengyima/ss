...
def main():
	...
	os.system(f"cd /cache/ss/Pointwise && python runBert.py --model_path /cache/mymodel \
		--per_gpu_batch_size 128 --log_path /cache/output/logs --save_path /cache/output/models --epochs 3")
