...
def main():
	...
	os.system(f"cd /cache/ss/Pairwise && python runBert.py --model_path /cache/data/BertModel/ \
		--per_gpu_batch_size 64 --log_path /cache/output/logs --save_path /cache/output/models --epochs 3 \
		--pretrain_model_path /cache/data/BertContrastive/BertContrastive.sent_del.aol")
