...
s3_output_path = s3_rootdir + "/output/yutao/ss_pt_ft_3_01_128_tg/"
...
def main():
	...
	os.system(f"cd /cache/ss/Pointwise && python runBert.py --task tiangong --score_file_path /cache/output/BertContrastive.tiangong.5.10.128.sent_deletion.term_deletion.qd_reorder.score.txt --bert_model_path /cache/data/BertChinese/ --per_gpu_batch_size 64 --log_path /cache/output/pointwise/logs/ --save_path /cache/output/pointwise/models/bert_sessionsearch.tiangong.5.10.128.sent_deletion.term_deletion.qd_reorder --epochs 3 --pretrain_model_path /cache/output/pretraining/models/BertContrastive.tiangong.5.10.128.sent_deletion.term_deletion.qd_reorder --learning_rate 5e-5")
