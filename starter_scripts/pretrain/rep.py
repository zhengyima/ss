...
s3_output_path = s3_rootdir + "/output/yutao/rep/"
...
def main():
    ...
    os.system(f"cd /cache/ss/Pointwise && python analyze_result.py --cl_model_path /cache/mymodel/pre_training/models/BertContrastive.aol.5.10.128.sent_deletion.term_deletion.qd_reorder --bert_model_path /cache/data/BertModel/ test_file_path ../data/aol/test.pos.all.txt")
