...
def main():
    ...
    os.system(f"cd /cache/ss/Pointwise && python analyze_result.py --cl_model_path /cache/mymodel/pre_training/models/BertContrastive.aol.5.10.128.sent_deletion.term_deletion.qd_reorder --bert_model_path /cache/data/BertModel/")
