...
# 	--pretrain_model_path /cache/output/pretraining/models/BertContrastive.aol.1.1.sent_deletion.term_deletion.qd_reorder")
	os.system(f"cd /cache/ss/Pretraining && python runBertContras.py --bert_model_path /cache/data/BertModel/ --batch_size 512 --log_path /cache/output/pretraining/logs/ --save_path /cache/output/pretraining/models/ --epochs 5 --temperature 0.1 --aug_strategy sent_deletion,term_deletion,qd_reorder")
	os.system(f"cd /cache/ss/Pointwise && python runBert.py --score_file_path /cache/output/BertContrastive.aol.5.10.sent_deletion.term_deletion.qd_reorder.score.txt --bert_model_path /cache/data/BertModel/ --per_gpu_batch_size 64 --log_path /cache/output/pointwise/logs/ --save_path /cache/output/pointwise/models/bert_sessionsearch.aol.5.10.sent_deletion.term_deletion.qd_reorder --epochs 3 --pretrain_model_path /cache/output/pretraining/models/BertContrastive.aol.5.10.sent_deletion.term_deletion.qd_reorder --learning_rate 1e-4")
	os.system(f"cd /cache/ss/Pretraining && python runBertContras.py --bert_model_path /cache/data/BertModel/ --batch_size 512 --log_path /cache/output/pretraining/logs/ --save_path /cache/output/pretraining/models/ --epochs 5 --temperature 0.05 --aug_strategy sent_deletion,term_deletion,qd_reorder")
	os.system(f"cd /cache/ss/Pointwise && python runBert.py --score_file_path /cache/output/BertContrastive.aol.5.5.sent_deletion.term_deletion.qd_reorder.score.txt --bert_model_path /cache/data/BertModel/ --per_gpu_batch_size 64 --log_path /cache/output/pointwise/logs/ --save_path /cache/output/pointwise/models/bert_sessionsearch.aol.5.5.sent_deletion.term_deletion.qd_reorder --epochs 3 --pretrain_model_path /cache/output/pretraining/models/BertContrastive.aol.5.5.sent_deletion.term_deletion.qd_reorder --learning_rate 1e-4")
