...
s3_output_path = s3_rootdir + "/output/yutao/tune_tg_2/"
...
def main():
    ...
    os.system(f"cd /cache/ss/Pretraining && CUDA_VISIBLE_DEVICES=0,1,2,3 python runBertContras.py --task tiangong --bert_model_path /cache/data/BertModel/ --per_gpu_batch_size 128 --log_path /cache/output/pretraining/logs/ --save_path /cache/output/pretraining/models/ --epochs 5 --temperature 0.05 --aug_strategy sent_deletion,term_deletion,qd_reorder --ratio 0.3")
    ...
    os.system(f"cd /cache/ss/Pretraining && CUDA_VISIBLE_DEVICES=0,1,2,3 python runBertContras.py --task tiangong --bert_model_path /cache/data/BertModel/ --per_gpu_batch_size 128 --log_path /cache/output/pretraining/logs/ --save_path /cache/output/pretraining/models/ --epochs 5 --temperature 0.3 --aug_strategy sent_deletion,term_deletion,qd_reorder --ratio 0.4")
